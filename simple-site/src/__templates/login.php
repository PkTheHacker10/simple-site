            ...
            <form class="mt-6" action="login.php" method="post">
                <div>
                    ...
                    <input type="text"
                        ...
                        placeholder="Email or Username" name="email" value="" required>
                </div>
                <div class="mt-4">
                    <label class="block text-gray-400">Password</label>
                    <input type="password"
                        class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Enter your password" name="pass" value="" required>
                </div>
                <button type="submit"
                    class="w-full bg-blue-500 text-white py-2 mt-6 rounded-lg hover:bg-blue-600">Login</button>
            </form>
            <p class="mt-4 text-center text-gray-500">Don't have an account? <a href="signup.php"
